...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedStrings = {
    ...
    'es': {
      ...
      'createSegmentDetailsTitle': 'Detalles del segmento',
      'createSegmentEndCoordinatesHint': '41.8322163,26.1404669',
      'createSegmentEndCoordinatesLabel': 'Punto final',
      'createSegmentEndLabel': 'Fin',
      'createSegmentEndNameHint': 'Nombre del fin',
      'createSegmentMapInstructionBody':
          'Coloca o arrastra los marcadores para ajustar los puntos de inicio y fin. Las coordenadas se completan automáticamente al moverlos.',
      'createSegmentMapInstructionTitle': 'Ajusta el segmento en el mapa',
      'createSegmentNameHint': 'Nombre del segmento',
      'createSegmentNameLabel': 'Nombre del segmento',
      'createSegmentRoadNameHint': 'Nombre de la carretera',
      'createSegmentRoadNameLabel': 'Nombre de la carretera',
      'createSegmentStartCoordinatesHint': '41.8626802,26.0873785',
      'createSegmentStartCoordinatesLabel': 'Coordenadas iniciales',
      'createSegmentStartLabel': 'Inicio',
      'createSegmentStartNameHint': 'Nombre del inicio',
